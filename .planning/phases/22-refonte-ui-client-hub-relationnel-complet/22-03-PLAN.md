...
<task type="auto">
  ...
  <verify>
    ...
    Backend response includes tracksCount and hoursRecorded fields (verify with console.log or React DevTools)
    Cards mode displays stats correctly (tracksCount and hoursRecorded visible in UI)
  ...
  <done>
    ...
    Backend aggregation verified to match component expectations
  </done>
</task>
