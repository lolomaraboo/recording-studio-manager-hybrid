...
<task type="auto">
  ...
  <action>
    ...
    **IMPORTANT - Verify AudioPlayer component exists:**
    Before implementing, verify AudioPlayer component exists at expected path:
    - Check file exists: `packages/client/src/components/AudioPlayer.tsx`
    - Verify expected props interface (likely: audioUrl: string, autoplay?: boolean, className?: string)
    - If component missing or props mismatch, document in verification step
  ...
  <verify>
    AudioPlayer component exists at packages/client/src/components/AudioPlayer.tsx
    AudioPlayer props match expected interface (audioUrl at minimum)
  ...
  <done>
    ...
    AudioPlayer component integration verified
  </done>
</task>
