...
<task type="auto">
  ...
  <action>
    ...
    **Schema compatibility:**
    - Uses drizzle-kit migrate with explicit config flag (not manual SQL) to apply all 12 migrations
...
<task type="auto">
  <name>Create realistic seed data script with faker.js</name>
  <files>
    packages/database/scripts/init/seed-realistic-data.ts
  </files>
  <action>
    ...
    **THEN: Create comprehensive seed script**
