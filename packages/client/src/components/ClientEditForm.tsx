...
export function ClientEditForm({
  ...
  const handleAccordionTriggerClick = (event: React.MouseEvent) => {
    if (event.altKey) {
      ...
      // Dynamic accordion list based on client type
  ...
  return (
    <div className="space-y-2">
      {/* Type de client - ABOVE ALL ACCORDIONS */}
      <Card>
      ...
      {/* Accordéon 4: Profil Artistique (genres, instruments, professional, career) - Only for individuals */}
      {formData.type === "individual" && (
      ...
      {/* Accordéon 5: Plateformes de Streaming - Only for individuals */}
      {formData.type === "individual" && (
