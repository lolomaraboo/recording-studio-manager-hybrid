...
export function ClientEditForm({
  ...
  return (
    ...
    >
      ...
      {/* Accordéon 4: Personal Information */}
      ...
      {/* Accordéon 5: Streaming Platforms */}
      ...
      {/* Accordéon 6: Professional Information */}
      ...
      {/* Accordéon 7: Career & Biography */}
      <AccordionItem value="career">
        <Card>
          <AccordionTrigger className="px-4 py-3 hover:no-underline">
            <h3 className="text-lg font-semibold">Carrière & Biographie</h3>
          </AccordionTrigger>
          <AccordionContent>
            <div className="px-4 pb-3 space-y-3">
              {/* Years active */}
